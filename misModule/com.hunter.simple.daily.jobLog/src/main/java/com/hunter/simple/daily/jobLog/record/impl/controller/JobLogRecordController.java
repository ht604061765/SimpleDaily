...
public class JobLogRecordController extends HunterBaseController<IJobLogRecordService> {
    ...
    @ActionLog(module = ModuleConstant.JOB_LOG, description = "新增一条工作日志")
    ...
    @ActionLog(module = ModuleConstant.JOB_LOG, description = "获取工作日志列表")
    ...
    @ActionLog(module = ModuleConstant.JOB_LOG, description = "删除一条工作日志")
    ...
    @ActionLog(module = ModuleConstant.JOB_LOG, description = "查询一条工作日志数据")
